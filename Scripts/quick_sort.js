...
function quick_partition (start, end)
{
    ...
    div_update(div[start],div_sizes[start],"yellow");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(div[j],div_sizes[j],"red");//Color update
                ...
                div_update(div[j],div_sizes[j],"red");//Height update

                div_update(div[i],div_sizes[i],"blue");//Height update
                div_update(div[j],div_sizes[j],"blue");//Height update

                i += 1;
            }
    }
    div_update(div[start],div_sizes[start],"red");//Color update
    ...
    div_update(div[start],div_sizes[start],"red");//Height update
